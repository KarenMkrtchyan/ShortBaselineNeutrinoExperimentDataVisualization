void width() {
    ...
    TCanvas *c1 = new TCanvas("c1", "Width Histograms", 800, 600); //needed so h can be properly selected later on

for(int k =0; k<2; k++){//Draw param (do not ask why it didn't work being the 3rd loop in the nest)
